...
@app.cell
def _(pd):
    data = pd.read_csv('https://raw.githubusercontent.com/TimGyger/VIF/refs/heads/main/Real%20World/Gaussian/Keggu/keggu.txt', sep=" ", header=None)
    return (data,)
...
def _(
    ...
    for j in range(5):
        ...
        y_test = np.asarray(y_test_tensor)
        print(f'Split {j + 1} Test Response: {y_test}')
        print(y_test.size)
        likelihood = gpytorch.likelihoods.GaussianLikelihood()
